...
function moveHighlight(previouslyHighlightedOption, diff, props) {
  ...
  return getNewHighlightedOption(options, previouslyHighlightedOption, diff, disabledItemsFocusable ?? false, isOptionDisabled ?? (() => false), disableListWrap ?? false, optionComparer ?? ((o1, o2) => o1 === o2));
}
...
function handleTextNavigation(state, searchString, props) {
  ...
  let nextOption = startWithCurrentOption ? state.highlightedValue : getNewHighlightedOption(options, state.highlightedValue, 1, disabledItemsFocusable ?? false, isOptionDisabled ?? (() => false), disableListWrap ?? false, optionComparer);
  ...
  for (let index = 0; index < options.length; index += 1) {
    ...
    nextOption = getNewHighlightedOption(options, nextOption, 1, disabledItemsFocusable ?? false, isOptionDisabled ?? (() => false), disableListWrap ?? false, optionComparer);
  }
